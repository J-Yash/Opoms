...
<%
    ...
    if (request.getMethod().equalsIgnoreCase("post")) {
        String Company_name = request.getParameter("Company_name");
            ...
            list = DBManager.SearchPurchaseOrderAll(Company_name);
...
<html>
        ...
        function validatedelete(poNumber)
            {
                ...
                if (choice === true)
                {
                    var ref = "PoAllToPending.jsp?poNumber=" + poNumber;
                    location.href = ref;
                } else
                {
    ...
    <body>
        <div class="container-fluid">
            ...
            <div id="content">
               <center><p style="font-size: 30px; font-family: sans-serif; font-weight: bolder;font-style: italic; color: brown ;"><b>All Purchase Orders</b></p></center>
              <center><input style="margin-right: 10px ;" class="btn btn-lg btn-warning" type="button" value="View Pending Purchase Orders" name="View Pending Purchase Orders" onclick="location.href = 'PoListView.jsp'"  /></center>
               <br/> 
              <div id="form">
                <form class="form-group-sm" name="searchProductForm" action="PoListViewAll.jsp" method="POST">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <input class="btn btn-sm btn-success" type="button" value="Edit" name="editProduct" onclick="location.href = 'EditProduct.jsp?Product_code=<%=po.getPoNumber() %>'"  />
                                <input class="btn btn-sm btn-danger" type="button" value="Move to Pending" name="deleteProduct" onclick="validatedelete(<%=po.getPoNumber()%>)" />
                            </td>
